          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="index-video.html">Admin</a></li>
              </ul>
            </li>
          </ul>
        </div>
                ...
                <div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
                  ...
                  <div class="panel panel-skin">
                    <div class="panel-heading">
                      <h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Already have an account? Log in <small>(It's free!)</small></h3>
                    </div>
...
<a class="button" style="vertical-align:auto" href="doclog.jsp"><span>Doctor </span></a>
<a class="button" style="vertical-align:auto" href="patlog.jsp"><span>Patient </span></a>

<br>
<br>
<br>
<h6 style="color:#CCC;text-align:center;font-size:14px;">*Don't have an account? <a href="patlog.jsp">Sign up</a></h6>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <p>
                  Submit your details in simple form
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <p>
                  We have a variety of packages covering different health symptoms.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Sample Collection at Doorstep</h4>
                <p>
                  Have your blood sample collected at your doorstep.
                </p>
              </div>
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Get help from Specialist</h4>
                <p>
                  We have a great range of world class doctors, each specialised in their sector.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="wow lightSpeedIn" data-wow-delay="0.1s">
                    <div class="cta-btn">
                      <a href="patlog.jsp" class="btn btn-skin btn-lg">Book an appoinment</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5 class="h-light">Medical Test</h5>
                  <p>With best brands of automated analyzers, barcoded system, bi-directional interfacing, total laboratory automation; Thyrocare succeeded in delivering quality reports.</p>
                </div>
              </div>
            </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5 class="h-light">Medical </h5>
                  <p>Medicio has made right use of the advanced superior technology, capable of working on its unbelievable volumes and yet deliver quality and precision to its customers.</p>
                </div>
              </div>
            </div>
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5 class="h-light">Report </h5>
                  <p>A laboratory processing over 60,000 samples and above 2.5 lakhs investigations everyday.</p>
                </div>
              </div>
            </div>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="service-box">
                ...
                <div class="service-desc">
                  <h5 class="h-light">Report Home Delivery</h5>
                  <p>We deliver reports to your home!</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-8 col-lg-offset-2">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="section-heading text-center">
                ...
                <p>Our world class range of doctors.</p>
              </div>
            </div>
          ...
          <div class="col-sm-4 pricing-box">
            <div class="wow bounceInUp" data-wow-delay="0.1s">
              <div class="pricing-content general">
                <h2>Happy Heart Panel</h2>
                <h3> <strong>Rs.</strong>1389<sup>.99</sup> <span>/ one time</span></h3>
                <ul>
                  <li>Sugar(F) <i class="fa fa-check icon-success"></i></li>
                  <li>Lipid Profile Basic(Cholestrol, Triglyceride, HDL Cholestrol, LDL Cholestrol, HDLD Cholestrol, Non-LDL Cholestrol)<i class="fa fa-check icon-success"></i></li>
                  
                  <li>Uric Acid<i class="fa fa-check icon-success"></i></li>
                  <li>Urea<i class="fa fa-check icon-success"></i></li>
                  <li><del>Health Screening Report Home-Delivery</del> <i class="fa fa-times icon-danger"></i></li>
                </ul>

                <div class="price-bottom">
                  <a href="patlog.jsp" class="btn btn-skin btn-lg">Purchase</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4 pricing-box featured-price">
            <div class="wow bounceInUp" data-wow-delay="0.3s">
              <div class="pricing-content featured">
                <h2>Swasth Super 1</h2>
                <h3> Rs.<strong>2289</strong><sup></sup> <span>/ one time</span></h3>
                <ul>
                  <li>Lipid Profile <i class="fa fa-check icon-success"></i></li>
                  <li>Screen(Cholestrol, Triglyceride, HDL Cholestrol, LDL Cholestrol, HDLD Cholestrol, Non-LDL Cholestrol) <i class="fa fa-check icon-success"></i></li>
                  <li>Thyroid Total Profile <i class="fa fa-check icon-success"></i></li>
                  <li>Kidney Profile Test <i class="fa fa-check icon-success"></i></li>
                  <li>Creatinine <i class="fa fa-check icon-success"></i></li>
                  <li>Health Screening Report Home-Delivery <i class="fa fa-check icon-success"></i></li>
                </ul>
          ...
          <div class="col-sm-4 pricing-box">
            <div class="wow bounceInUp" data-wow-delay="0.2s">
              <div class="pricing-content general last">
                <h2>Swasth Super 2</h2>
                <h3> <strong>Rs.</strong>1227<sup></sup> <span>/ one time</span></h3>
                <ul>
                  <li>Hb1Ac <i class="fa fa-check icon-success"></i></li>
                  <li>Complete Blood Count <i class="fa fa-check icon-success"></i></li>
                  <li>Liver Function Test <i class="fa fa-check icon-success"></i></li>
                  <li>Total Thyroid Test <i class="fa fa-check icon-success"></i></li>
                  <li>Heart Function Test <i class="fa fa-check icon-success"></i></li>
                  <li><del>Health Screening Report Home Delivery</del> <i class="fa fa-times icon-danger"></i></li>
                </ul>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                <h5>Our location</h5>
                <p>GP Road Bag More, Kanchrapara(Near W.B.N.V.F Gate)West Bengal, India</p>
