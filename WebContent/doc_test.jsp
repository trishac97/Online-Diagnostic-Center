...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="doc_test" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Diagnostic Test</b></h3></legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button type="submit" class="btn btn-warning">Fetch Completed Appointment <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</form>
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                                    <td><button class="btn btn-danger btn-sm"><a href="doc_test_form.jsp?booking_ref=<%=appobj.getBooking_ref()%>&p_email=<%=appobj.getP_email()%>&d_email=<%=appobj.getD_email() %>"> Assign Diagnostic Test </button></a></td>      
