...
<a href="patlog.jsp"><input type="button" value="Sign out" onclick="displaymessage1()" class="btn btn-danger btn-sm"></input></a>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="pat_cancel" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Cancel Upcoming Appointments</b></h3></legend>
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div style="color: #006400;background-color: rgba(0,255,0,0.3)"><b>
    				<%
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                                         <td><a  href="pat_cancel_form.jsp?booking_ref=<%=appobj.getBooking_ref()%>"><button class="btn btn-danger btn-sm">Cancel Appointment</button></a></td>      
