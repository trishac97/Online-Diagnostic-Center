...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="pat_feedback" method="get" style="border:none;">
...
<div class="form-group">
  ...
  <div style="color: #006400;background-color: rgba(0,255,0,0.5)"><b>
    				<%
    ...
    <br>
  <div class="col-md-4">
    <button type="submit" class="btn btn-warning">Fetch Appointments! <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</div>
</form>
...
<%! List<AppHistoryDetails> applist=null; %>  
 ...
 %>
   ...
   if(appobj.getFlag().equals(f))
   {
 %>

                     <td><button><a  href="pat_feedback_form.jsp?booking_ref=<%=appobj.getBooking_ref()%>&p_email<%=appobj.getP_email()%>&d_email=<%=appobj.getD_email()%>"> Feedback </a></button></td>      
                       <%
   }
                       %>  
   </tr>  
