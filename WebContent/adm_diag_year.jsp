...
ADMINISTRATOR					</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="adm_diag_year" method="get" style="border:none;padding-left: 100px">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Diagonistic Test Income per year</b></h3></legend>
<div class="form-group">
  ...
  <input id="id1" name="appointment_date" placeholder="Enter year" class="form-control"  type="text">
    </div>
  </div>
