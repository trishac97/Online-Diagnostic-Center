...
%>
  ...
  <%= first_name %> 				</div>
    ...
    <form class="well form-horizontal" action="doc_update" method="get"  id="contact_form" style="border:none;">
<fieldset>

<!-- Form Name -->
<legend><h3 style="color:white;">Doctor Update Form</h3></legend>
...
<div class="form-group">
  <label class="col-md-4 control-label">Salary</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="salary" id="id5" placeholder="Salary" class="form-control" type="text">
    </div>
  </div>
</div>
