...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <div id="wrapper">
    ...
    <form class="well form-horizontal" action="patreg" method="get"  id="contact_form" style="margin-top: 150px;background-color: rgba(0,0,0,0.3);margin-left: 100px;margin-right: 100px;">
<fieldset>

<!-- Form Name -->
<legend><h2 style="color:white">New Patient Registration Form</h2></legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" style="color:white">Zip Code</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="zip" placeholder="state" class="form-control"  type="text">
    </div>
</div>
</div>
