...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="doc_futuredate" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3 style="color:white;">View Upcoming Appointment @ Day</h3></legend>
...
<div class="form-group">
  ...
  <input id="id1" name="appointment_date" placeholder="Search Doctor By Department.." class="form-control"  type="date">
    </div>
  </div>
</div>
<br>
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div class="col-md-4">
    <button type="submit" class="btn btn-warning">Fetch Upcoming Appointments <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</form>
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                               <td><a href="doc_enablefeedback?booking_ref=<%=appobj.getBooking_ref()%>"><button class="btn btn-danger btn-sm"> Enable Feedback </button></a></td>      
