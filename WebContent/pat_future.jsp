...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="pat_future" method="get" style="border:none;">
...
<div class="form-group">
  ...
  <div style="color: #006400;background-color: rgba(0,255,0,0.5);text-align: center;"><b>
    				<%
