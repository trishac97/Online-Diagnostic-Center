...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="doc_futuremonth" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">View Upcoming Appointment @ Month</b></h3></legend>
 ...
 %>
   <tr>
     ...
     <td><%= appobj.getD_email() %></td>
      ...
      <td><button class="btn btn-danger btn-sm"><a href="doc_enablefeedback?booking_ref=<%=appobj.getBooking_ref()%>"> Enable Feedback </button></a></td>      
