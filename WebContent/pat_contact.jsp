...
%>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow: hidden; height:550px;">
	    <form class="well form-horizontal" action="pat_contact" method="get" style="border:none;">
	    <legend><h3><b style="color:white;">Contact Us</b></h3></legend>
...
Patient FName
  ...
  <input id="id1" name="first_name" value =<%=first_name%> class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
...
<br>
 <div class="col-sm-12">
  ...
  <textarea name="message" placeholder="Message" class="form-control"   row="2" col="30"></textarea>
    </div>
  </div>
</div>
<br>
