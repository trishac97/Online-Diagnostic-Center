...
<%! String email=""; %>
  ...
  %>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="adm_today_app" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Today's Appointments</b></h3></legend>
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                                         <td><button class="btn btn-warning"><a  href="pat_cancel_form.jsp?booking_ref=<%=appobj.getBooking_ref()%>">Cancel Appointment</a></button></td>      
