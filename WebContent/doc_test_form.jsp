...
<%! 
   String booking_ref,d_email,p_email;
String first_name="";
%>
  ...
  d_email = (String)request.getParameter("d_email");
      p_email= (String)request.getParameter("p_email");
  %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow: scroll; height:550px;">
	    <form class="well form-horizontal" action="doc_test_form" method="get" style="border:none;overflow-y:scroll;">
	    <legend><h3 style="color:white;">Diagnostic Test</h3></legend>
...
<div style="color: #006400;background-color:rgba(0,255,0,0.3);font-weight: bold;text-align: left ;">
    <%
        	...
        	out.print("You are assigning diagnostic test for Booking Reference: "+booking_ref);
    %>
    </div>
<!-- Form Name -->
 ...
 <b>Booking Reference:</b>
  ...
  <input id="id1" name="d_email" value =<%=d_email%> placeholder="Doctor Last Name" class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
...
<br>
 <div class="col-sm-12">
  ...
  <div class="col-md-10">
<b>Diagnostic Test Name:</b>
  
  <input name="test_name" value ="Swatch Swastha I"   type="radio" style="margin-left: 20px;"><b>Swatch Swastha I</b>
    <input name="test_name" value ="Swatch Swastha II"   type="radio" style="margin-left: 20px;"><b>Swatch Swastha II</b>
    <input name="test_name" value ="Swatch Swastha III"   type="radio" style="margin-left: 20px;"><b>Swatch Swastha III</b>
...
<br>
 ...
 <div class="col-sm-12">
  ...
  <div class="col-md-10 inputGroupContainer">
<b>Diagnostic Test Price:</b>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-inr"></i></span>
  <input id="id1" name="test_price" placeholder="Price" class="form-control"  type="text">
    </div>
  </div>
</div>
<br>
