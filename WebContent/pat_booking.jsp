...
%>
  ...
  pusrid=(String)session.getAttribute("email");
      docid = (String)request.getParameter("docemail");
      docfname= (String)request.getParameter("docfname");
      doclname=(String)request.getParameter("doclname");
      pursalary=(String)request.getParameter("docsal");
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow: hidden; height:550px;">
	    <form class="well form-horizontal" action="pat_booking" method="get" style="border:none;">
	    <legend><h3><b style="color:white;">Appointment Scheduling Form</b></h3></legend>
...
<div style="color: #006400;background-color:rgba(0,255,0,0.3);font-weight: bold;text-align: left ;">
    <%
        	...
        	out.print("You are booking for Dr. "+docfname+" "+doclname);
    %>
    </div>
<!-- Form Name -->
 ...
 Doctor FName
  ...
  <input id="id1" name="first_name" value =<%=docfname%> class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input id="id1" name="last_name" value =<%=doclname%> placeholder="Doctor Last Name" class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
  ...
  <input id="id1" name="d_email" value =<%=docid%> class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
<br>
...
<br>
  ...
  <input name="appointment_date" id="datepicker" class="form-control" type="date"  >
    </div>
  </div>
</div>
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input id="thisField" name="p_email" class="form-control" value="<%=pusrid%>" readonly>
  ...
  <input id="thisField" name="salary" class="form-control" value="<%=pursalary%>" readonly>
...
<br>
 <div class="col-sm-12">
  ...
  <textarea name="appointment_reason" placeholder="Reason" class="form-control"  rows="2" cols="50">
