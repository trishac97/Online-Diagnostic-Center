...
<script>
 function displaymessage() 
       {
           alert("Are you sure you want to delete this doctor?")
...
%>
  ...
  %>
	...
	<div id="below" style="overflow: hidden; height:550px;">
	    <form class="well form-horizontal" action="adm_del" method="get" style="border:none;">
	    <legend><h3><b style="color:white;">Appointment Form</b></h3></legend>
...
<div style="color: #006400;background-color:rgba(0,255,0,0.3);font-weight: bold;text-align: left ;">
    <%
        	...
        	out.print("You are deleting Dr. "+docfname+" "+doclname);
    %>
    </div>
<!-- Form Name -->
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <button  class="btn btn-warning"><input type="button" class="btn btn-warning" value="Delete Doctor" onclick="displaymessage()"><span class="glyphicon glyphicon-send"></span></input></button>
  </div>
</div>
</form>
