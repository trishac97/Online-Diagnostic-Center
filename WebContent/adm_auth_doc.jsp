...
<meta charset="utf-8">
  ...
  <title>Medicio Doctor Authentication</title>
...
<%! String first_name=""; String userid=""; %>
  ...
  %>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="adm_auth_doc" method="get" style="border:none;">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Doctor Authentication</b></h3></legend>
...
<%! List<DoctorDetails> doctlist=null; %>  
 ...
 %>
   ...
   if(docobj.getFlag().equals("false"))
   {
 %>

2                    <td><a  href="adm_auth?d_email=<%=docobj.getEmail()%>"><button type="button" class="btn btn-danger btn-sm"> Enable Doctor </button></a></button></td>      
                       <%
                       }
                       %>  
