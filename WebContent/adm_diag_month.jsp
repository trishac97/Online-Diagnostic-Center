...
ADMINISTRATOR					</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="adm_diag_month" method="get" style="border:none;padding-left: 100px">
	
     <div class="container" style="margin-left:0px;margin-bottom:0px;padding:0px;">    
         
<legend><h3><b style="color:white;">Diagonistic Test Income per month</b></h3></legend>
