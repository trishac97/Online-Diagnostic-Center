...
%>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow: hidden; height:550px;">
	    ...
	    <legend><h3><b style="color:white;">Appointment Cancellation Form</b></h3></legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <button  class="btn btn-warning"><input type="button" class="btn btn-warning" value="Cancel Appointment" onclick="displaymessage()"><span class="glyphicon glyphicon-send"></span></input></button>
  </div>
</div>
</form>
