...
%>
  ...
  pusrid=(String)session.getAttribute("email");
     ...
     amount=(String)request.getAttribute("servermsg");
  %>
  ...
  <%= first_name  %> 				</div>
				...
				<div class="profile-usermenu">
					<ul class="nav">
						<li>
							...
							<i class="glyphicon glyphicon-user"></i>Today's Appointments </a>
						</li>
						<li class="active">
	...
	<div id="below" style="overflow: hidden; height:550px;">
	    <form class="well form-horizontal" action="pat_cancel_form" method="get" style="border:none;">
	    <legend><h3><b style="color:white;">Amount Raised today</b></h3></legend>
...
Amount:
  ...
  <input id="id1" name="booking_ref" value =<%=amount%> class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
