...
@WebServlet("/doc_futuredate")
public class doc_futuredate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public doc_futuredate() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String appointment_date = request.getParameter("appointment_date");
	      ...
	      //CALL DAO METHOD
   	    List<AppHistoryDetails> applist = cdaoobj.fetchAllRecorddate(appointment_date,email);
	    String nextviewpage="";
	    
	    if(applist.size() > 0)
	    {
	    	request.setAttribute("custinformationlist", applist);
	    	nextviewpage ="doc_futuredate.jsp";
	    }
	    else
	    {
