...
@WebServlet("/adm_income_year")
public class adm_income_year extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public adm_income_year() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		System.out.println("U enter:"+request.getParameter("appointment_date"));
	 	   int replyfromdao=cdaoobj.income_year(appobj);
	 	   String msg="";
	 	 ...
	 	 String number = intInstance.toString();
	 	   ...
	 	   RequestDispatcher rd=request.getRequestDispatcher("/adm_income_year.jsp");
